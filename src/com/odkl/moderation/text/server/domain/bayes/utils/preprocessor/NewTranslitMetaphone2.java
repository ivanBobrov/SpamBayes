...
public class NewTranslitMetaphone2 implements SpamTextPreprocessor {
        ...
        protected String encodeMetaphone(StringBuilder string, RawStringType rawStringType) {
                ...
                /**/
                        case 'Ч':
                        case '4':
                                result.append((!cyrillic || isNextDigit(string, pos)) ? '4' : "CH");
                                break;
                /**/
                        case 'Х':
                                result.append('H');
                ...
                /**/
                        case 'Й':
                                if (isNext(string, pos, 'А')) {
                                        result.append("YA");
                                        ++pos;
                                } else if (isNext(string, pos, 'Е')) {
                                        result.append("E");
                                        ++pos;
                                } else if (isNext(string, pos, 'О')) {
                                        result.append("E");
                                        ++pos;
                                } else {
                                        result.append('Y');
                ...
                /**/
                        ...
                        default:
                                if ((leaveDigits && isDigit(currentChar)) || currentChar == ' ' || currentChar == '~') {
